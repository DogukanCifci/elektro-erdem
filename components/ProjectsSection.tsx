...
const ProjectsSection: React.FC<ProjectsSectionProps> = ({
  ...
  const [filterCategory, setFilterCategory] = useState<
    "all" | "residential" | "commercial" | "installation" | "automation"
  >("all");
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex flex-wrap gap-2 justify-center md:justify-start">
            <span className="flex items-center text-slate-500 mx-2 text-sm">
              <Filter size={16} className="mx-1" /> Filter:
            </span>
            {[
              ...
              { id: "installation", label: t.projects.filterInd[lang] },
          ...
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            <span className="flex items-center text-slate-500 text-sm">
              <ArrowUpDown size={16} className="mx-1" /> Sort:
            </span>
            <select
